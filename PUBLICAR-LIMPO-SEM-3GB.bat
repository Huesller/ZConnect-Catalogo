...
echo ============================================================
echo ZCONNECT - PUBLICACAO LIMPA V12.7.2 - SEM BAIXAR FOTOS
echo ============================================================
echo.
...
echo.
echo [2/6] Copiando somente os arquivos da versao 12.7.2...
call :copyfile ".env.example"
if errorlevel 1 goto :copy_failed
call :copyfile "PAINEL-COMERCIAL-OFERTAS-ASSINADAS.html"
if errorlevel 1 goto :copy_failed
call :copyfile "PAINEL-COMERCIAL-OFERTAS-SEM-SENHA-BUILD-3.2.html"
if errorlevel 1 goto :copy_failed
...
git -C "%CLEAN%" commit -m "Atualiza ofertas sem senha v12.7.2"
...
echo.
echo ============================================================
echo PUBLICADO COM SUCESSO - ENVIO LIMPO SEM FOTOS
echo ============================================================
echo.
